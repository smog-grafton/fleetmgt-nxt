...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="min-h-screen bg-muted/25">
    ...
    <div className={cn('transition-[padding] lg:ps-[280px]', collapsed && 'lg:ps-[76px]')}>
      ...
      <footer className="flex flex-wrap items-center justify-between gap-2 border-t bg-background px-6 py-4 text-xs text-muted-foreground"><span>© {new Date().getFullYear()} Zuri Ride · Management V2</span><span>Laravel Operations API · Zuri Management System</span></footer>
    </div>
